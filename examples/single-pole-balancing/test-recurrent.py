...
result_path = "results/2026-04-04-22-12"

with open(result_path + "/winner-recurrent.pickle", 'rb') as f:
    c = pickle.load(f)
...
net = neat.RecurrentNetwork.create(c, config)
sim = CartPole()
...
print()
print("Making movie...")
make_movie(net, discrete_actuator_force, 15.0, result_path + "/recurrent-movie.mp4")
